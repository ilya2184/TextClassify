...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокНомеров = "Заявка 02_ФА_7748
	|П_7747
	|ФА_7748
	|Заявка 01_ФА_7748
	|2П3_141272/7298/У
...
Процедура ПодобратьНомер(Команда)
	...
	ОтветСервера = ПодобратьНомерНаСервере(СписокНомеров, НазначениеПлатежа);
...
&НаСервереБезКонтекста
Функция ПодобратьНомерНаСервере(СписокНомеров, НазначениеПлатежа)
	
	Номера = СтрРазделить(СписокНомеров, Символы.ПС);
	
	АдресСервиса = "http://127.0.0.1:5000";
	ПутьСервиса = "/stringmatch";
	ОтветСтрока = НаиболееПодходящаяСтрокаСервисом(Номера, НазначениеПлатежа, АдресСервиса + ПутьСервиса);
...
&НаСервереБезКонтекста
Функция НаиболееПодходящаяСтрокаСервисом(Номера, НазначениеПлатежа, ПутьСервиса)
